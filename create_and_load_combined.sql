CREATE DATABASE combined_t20_2015;

use combined_t20_2015;

CREATE TABLE combined_match_details(
...
CREATE TABLE combined_score_details(
    ...
    constraint foreign key for_key(match_id) REFERENCES combined_match_details(match_id),
...
LOAD DATA INFILE '/var/lib/mysql-files/combined_t20.batting.csv' INTO TABLE  combined_batting FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;


LOAD DATA INFILE '/var/lib/mysql-files/combined_t20.bowling.csv' INTO TABLE  combined_bowling FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;

LOAD DATA INFILE '/var/lib/mysql-files/combined_t20.score_details.csv' INTO TABLE  combined_score_details FIELDS TERMINATED  BY ',' OPTIONALLY ENCLOSED BY '"'    LINES TERMINATED BY '\n' IGNORE 1 LINES;
